...
public class OccupyNowActivity extends Activity{
...
//    }
    ...
    public void occupyNow(View v) {
        if (jBookings != null){
            ...
            String[] myTaskParams = {"http://localhost:8888/rooms/" + roomName + "/booking", postValues[0] ,  postValues[1]  , postValues[2] ,postValues[3], postValues[4], postValues[5] };
            myAsyncTaskPost post = new myAsyncTaskPost();
            post.setContext(getApplicationContext());
    ...
    public String[] getValues(){
        ...
        String[] postValues = {currentDate,"User's Meeting",currentTime,endTime, "TestUser", getApplicationContext().toString()};
    ...
    public void occupyLater(View v) {
        try {
            if (jBookings != null){
                Intent i = new Intent(getApplicationContext(), OccupyLaterActivity.class);
                String rName;
